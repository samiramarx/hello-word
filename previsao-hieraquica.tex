...
São comparados 5 métodos de previsão hierárquica, sendo eles \emph{bottom-up}, três variações do método top-dow, sendo uma delas recentemente proposta na literatura por \citeonline{hyndman2009}, e o método de combinação ótima, proposto também pelos mesmos autores.
...
Here are compared 5 methods of hierarchical forecast, wich are  bottom-up, three variations of the top-down method, one of them recently proposed in the literature by \citeonline{hyndman2009} ,and the optimum combination method, also proposed by the same authors.
